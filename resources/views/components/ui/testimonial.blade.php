...
<div class="card" class="bg-gradient-to-b! from-orange-100! via-white! to-blue-100!">
  <div class="content" class="bg-gradient-to-b! from-orange-100! via-white! to-blue-100!">
    <div class="header">
      <strong>{{$name}}</strong>
      <p class="para">{{$title}}</p>
    </div>
    <div class="footer">
      <svg viewBox="0 0 24 24" class="quotes">
        <path
          fill="black"
